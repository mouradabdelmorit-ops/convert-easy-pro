...
export const translations: Record<Language, {
  ...
  en: {
    ...
    footer: {
      ...
      company: 'Company',
      legal: 'Legal',
      copyright: '© 2024 TransformFiles.com. All rights reserved.',
    },
    about: {
  ...
  de: {
    ...
    footer: {
      ...
      company: 'Unternehmen',
      legal: 'Rechtliches',
      copyright: '© 2024 TransformFiles.com. Alle Rechte vorbehalten.',
    },
    about: {
  ...
  es: {
    ...
    footer: {
      ...
      company: 'Empresa',
      legal: 'Legal',
      copyright: '© 2024 TransformFiles.com. Todos los derechos reservados.',
    },
    about: {
  ...
  fr: {
    ...
    footer: {
      ...
      company: 'Entreprise',
      legal: 'Légal',
      copyright: '© 2024 TransformFiles.com. Tous droits réservés.',
    },
    about: {
  ...
  it: {
    ...
    footer: {
      ...
      company: 'Azienda',
      legal: 'Legale',
      copyright: '© 2024 TransformFiles.com. Tutti i diritti riservati.',
    },
    about: {
  ...
  pt: {
    ...
    footer: {
      ...
      company: 'Empresa',
      legal: 'Legal',
      copyright: '© 2024 TransformFiles.com. Todos os direitos reservados.',
    },
    about: {
